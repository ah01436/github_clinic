...
namespace Clinic_Management_System
{
    class cls_employee
    {
        ...
        public DataTable selct_employee()
        {
        ...
        public bool insertdata
            ...
            string phone2, string email,string position)
        {
        asd: try
            {
                ...
                param[5] = new MySqlParameter("sreg_date", MySqlDbType.Date, 10);
                param[5].Value = reg_date;
                param[6] = new MySqlParameter("sstatus", MySqlDbType.VarChar,10);
                param[6].Value = status;
                param[7] = new MySqlParameter("saddress", MySqlDbType.VarChar, 100);
                param[7].Value = address;
                param[8] = new MySqlParameter("semail", MySqlDbType.VarChar, 50);
                param[8].Value = email;
                param[9] = new MySqlParameter("sphone1", MySqlDbType.VarChar, 14);
                param[9].Value = phone1;
                param[10] = new MySqlParameter("sphone2", MySqlDbType.VarChar, 14);
                param[10].Value = phone2;
        ...
        asd: try
            {
                ...
                param[9].Value = email;
                exp_num = con.Exacute_procdure("update_employee", param);
                if (exp_num == 1)
                {
                    return true;
                }
