...
{
    public partial class item_expense : Form
    {
        ...
        private void item_expense_Load(object sender, EventArgs e)
        {
            dt = con.selectt("select * from item_expense");

            {
                dgv_Item_expense.DataSource = dt;
                dgv_Item_expense.Columns[0].ReadOnly = true;
                dgv_Item_expense.Columns[0].Width = 75;
                dgv_Item_expense.Columns[0].HeaderText = "الكود";
                dgv_Item_expense.Columns[1].HeaderText = "الاسم";
            }
        }
        ...
        private void btn_delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    foreach (DataGridViewRow item in this.dgv_Item_expense.SelectedRows)
                    {
                        dgv_Item_expense.Rows.RemoveAt(item.Index);
                    }
